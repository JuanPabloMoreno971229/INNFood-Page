"""
Django settings for innfood_page project.
...
SECRET_KEY = 'django-insecure-bjv27_oz2fa+5y8i28h4c!yh=26!x7=7-w=97pf^h(#g3ca-_p'
...
ROOT_URLCONF = 'innfood_page.urls'
...
WSGI_APPLICATION = 'innfood_page.wsgi.application'
